...
>
    ...
    <ProjectCard
        ...
        title="Backupable"
        description="Automated Remnawave backups with native and Docker installation, Telegram, Discord and Gmail delivery, proxy support, scheduling, and optional ZIP protection."
        author="AidarKhusainov"
        authorLink="https://github.com/AidarKhusainov"
        image="/awesome/remnawave-backuper.webp"
        githubRepo="AidarKhusainov/backupable"
        links={{
            github: 'https://github.com/AidarKhusainov/backupable',
            docs: 'https://github.com/AidarKhusainov/backupable/blob/master/README.md'
        }}
    >
