...
>
    ...
    <ProjectCard
        id="podlaz"
        title="Podlaz"
        description="A CLI-first Linux VPN client for Xray-compatible subscriptions, with local proxy mode and transaction-backed full-TUN networking."
        author="AidarKhusainov"
        authorLink="https://github.com/AidarKhusainov"
        image="/awesome/podlaz.webp"
        githubRepo="AidarKhusainov/podlaz"
        hwidSupported={true}
        links={{
            github: 'https://github.com/AidarKhusainov/podlaz'
        }}
    />
